  ...
  return (
    <div className="flex flex-col min-h-screen">
      <nav className="py-4 px-10 flex items-center gradient drop-shadow-xl border-b-2 border-none sticky top-0 z-50">
        <Link to="/" className="text-3xl text-white noto-serif hover:scale-105 duration-200">
        ...
        <div className="ml-auto flex text-white items-baseline gap-4">
          {navLinks.map((nav, index) => (
            <NavLink
              ...
              to={nav.link}
              className={({ isActive }) =>
                `navlinkStyle transition-transform duration-200 hover:scale-105 ${
      ...
      <footer className="text-center p-4 border-t gradient flex flex-col text-white pt-6 relative overflow-hidden">
        ...
        <div className="grid grid-cols-2 z-10 pb-4">
          <div className="w-72 hover:scale-105 duration-200">
            <Link to="/" className="text-3xl text-white noto-serif ">
              Microfinance Solution
            </Link>
          </div>
          <div>
            <ul className="text-white text-right">
              <li>microfinance-solution@gmail.com</li>
              <li>+63 9123456789</li>
        ...
        <div className="py-4 mt-auto flex z-10">
          <div className="flex gap-4 items-end">
            <p className="mt-auto">
              © 2025 Microfinance Solution - All Rights Reserved.
            </p>
