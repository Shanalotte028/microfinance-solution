    ...
    <>
      ...
      <div className="px-20 py-16 text-white gradient">
        ...
        <div className="flex justify-center gap-8 text-black mt-20 relative">
          <Link
            to="/signin"
            className="text-xl bg-white py-4 px-6 rounded-full font-medium text-[#00446b] hover:scale-105 duration-200"
          >
            Sign in
          </Link>
          {/* <Link
      ...
      <div className="py-12 flex flex-col items-center px-64 bg-white relative">
        <h3 className="italic text-center text-lg">
          Designed for microfinance institutions — our system streamlines lending operations, enhances client management, and drives financial inclusion.
        </h3>
